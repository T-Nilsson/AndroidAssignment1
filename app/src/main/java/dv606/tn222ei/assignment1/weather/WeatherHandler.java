...
//			} else
    ...
    /*
     *
     * <time from="2010-05-10T18:00:00" to="2010-05-11T00:00:00" period="w_3">
        <!-- Valid from 2010-05-10T18:00:00 to 2010-05-11T00:00:00 -->
        <symbol number="w_1" name="Klarvær" />
        <precipitation value="0.0" />
        <!-- Valid at 2010-05-10T18:00:00 -->
        <windDirection deg="266.w_8" code="W" name="Vest" />
        <windSpeed mps="w_4.w_7" name="Lett bris" />
        <temperature unit="celcius" value="w_11" />
        <pressure unit="hPa" value="1006.w_7" />
      </time>
     */
    @Override
