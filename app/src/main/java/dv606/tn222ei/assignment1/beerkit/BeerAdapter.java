...
public class BeerAdapter extends FragmentPagerAdapter {
   private ArrayList<BeerFragment> fragments = new ArrayList<BeerFragment>();

    public BeerAdapter(FragmentManager fm) {
        super(fm);
        fragments.add(BeerFragment.create(
                "Name: Mornin' Delight\n" +
                "Rating: 4.7\n" +
        ...
        fragments.add(BeerFragment.create(
                ...
                R.mipmap.pliny_the_younger));
        fragments.add(BeerFragment.create("Name: Heady Topper\n" +
                "Rating: 4.67\n" +
                ...
                R.mipmap.heady_topper));
        fragments.add(BeerFragment.create("Name: Kentucky Brunch Brand Stout\n" +
                "Rating: 4.66\n" +
                "Brewery: Toppling Goliath Brewing Company, Iowa, United States\n" +
                "Style: American Double / Imperial Stout\n" +
                "ABV: 12.00%\n" +
                ...
                R.mipmap.kentucky_stout));
        fragments.add(BeerFragment.create("Name: Pliny The Elder\n" +
                "Rating: 4.59\n" +
                "Style: American Double / Imperial IPA\n" +
                ...
                R.mipmap.pliny_the_younger));
        fragments.add(BeerFragment.create("Name: Norrlands Guld Export\n" +
                "Rating: 2.62\n" +
